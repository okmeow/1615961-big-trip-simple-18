...
const createOffersTemplate = (offer) => {
  const offersTemplate = offer.map(
    ({offers}) => `
    <div class='event__offer-selector'>
      <input class='event__offer-checkbox  visually-hidden' id='event-offer-${offers[0].title}-1' type='checkbox' name='event-offer-${offers[0].title}'>
      <label class='event__offer-label' for='event-offer-${offers[0].title}-1'>
        <span class='event__offer-title'>${offers[0].title}</span>
        &plus;&euro;&nbsp;
        <span class='event__offer-price'>${offers[0].price}</span>
      </label>
        ...
        <section class="event__details">
          <section class="event__section  event__section--offers">
            ...
            <div class="event__available-offers">
              ...
              ${createOffersTemplate([pointTypeOffer])}
...
export default class TripDestinationPointEditView extends AbstractStatefulView {
  ...
  get template() {
    return createDestinationPointEditTemplate(this.#point, this.#offer);
  }
  ...
  #formSubmitHandler = (evt) => {
    evt.preventDefault();
    this._callback.formSubmit(TripDestinationPointEditView.parsePointToTask(this.point));
  };
